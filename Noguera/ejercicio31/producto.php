...
class Producto{
    ...
    public static function ProductoExistenteBD($codigo_de_barra, $stock)
    {
        $vec = Producto::TraerTodosLosProductos();
        $productoExistente = false;
        ...
        foreach($vec as $auxProd)
        {
            if($auxProd->codigo_de_barra == $codigo_de_barra && $auxProd->stock >= $stock)
            {
                $productoExistente = true;
                break;
            }
    ...
    public static function ModificarStockBD($codigoBarra, $stock)
    {
        $vec = Producto::TraerTodosLosProductos();
        $productoExistente = false;
        ...
        foreach($vec as $auxProd)
        {
            if($auxProd->codigo_de_barra == $codigoBarra)
            {
                $productoExistente = true;
                $auxProd->stock -= $stock;
                $auxProd->ModificarProductoParametros();
                break;
            }
        }
