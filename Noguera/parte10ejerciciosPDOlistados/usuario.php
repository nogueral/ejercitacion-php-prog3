...
class Usuario 
{
	...
	public static function TablaUsuarioConParametro($lista){
    ...
    public static function ImprimirUsuariosConParametro($lista){
    ...
    public static function TraerTodosLosUsuariosOrdenados($order)
	{
        if($order == 1){
            ...
            $objetoAccesoDato = AccesoDatos::dameUnObjetoAcceso(); 
			$consulta =$objetoAccesoDato->RetornarConsulta("select * from usuario ORDER BY nombre ASC");
			$consulta->execute();	
